...
.method constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    iput-wide v2, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->b:J

    move-wide/from16 v4, p4

    iput-wide v4, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->c:J

    move/from16 v6, p6

    iput v6, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->d:F

    move-wide/from16 v7, p7

    iput-wide v7, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->e:J

    move/from16 v9, p9

    iput v9, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->f:I

    move-object/from16 v10, p10

    iput-object v10, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->g:Ljava/lang/CharSequence;

    move-wide/from16 v11, p11

    iput-wide v11, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->h:J
    ...
    iput-object v13, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->i:Ljava/util/List;
    ...
    iput-object v3, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Landroid/os/Bundle;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Landroid/os/Bundle;
...
.method public static a(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iput-object v0, v4, Landroid/support/v4/media/session/PlaybackStateCompat;->q:Ljava/lang/Object;
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->p:Landroid/os/Bundle;
