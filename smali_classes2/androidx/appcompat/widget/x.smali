...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/x;->j:Landroid/content/Context;
...
.method private a(Landroid/graphics/RectF;)I
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/x;->f:[I

    aget v5, v5, v4

    invoke-direct {p0, v5, p1}, Landroidx/appcompat/widget/x;->a(ILandroid/graphics/RectF;)Z
    ...
    :cond_1
    iget-object v4, p0, Landroidx/appcompat/widget/x;->f:[I
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v3, v5, v4}, Landroidx/appcompat/widget/x;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
...
.method private a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v0, v2, v1}, Landroidx/appcompat/widget/x;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_0
    invoke-direct {p0, p2}, Landroidx/appcompat/widget/x;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private a(F)V
    ...
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/x;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private a(Landroid/content/res/TypedArray;)V
    ...
    :cond_0
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/x;->a([I)[I

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/x;->f:[I

    invoke-direct {p0}, Landroidx/appcompat/widget/x;->j()Z
...
.method private a(ILandroid/graphics/RectF;)Z
    ...
    iput-object v3, p0, Landroidx/appcompat/widget/x;->h:Landroid/text/TextPaint;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;
    ...
    invoke-direct {p0, v3, v6, v5}, Landroidx/appcompat/widget/x;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, v3, v5, v2}, Landroidx/appcompat/widget/x;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    invoke-direct {p0, v0, v3, v5}, Landroidx/appcompat/widget/x;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;I)Landroid/text/StaticLayout;
...
.method private i()Z
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/x;->k()Z
    ...
    iget v2, p0, Landroidx/appcompat/widget/x;->d:F
    ...
    iget v4, p0, Landroidx/appcompat/widget/x;->e:F
    ...
    :cond_2
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/x;->a([I)[I

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/x;->f:[I
...
.method private j()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/x;->f:[I
    ...
    :cond_1
    iget-boolean v1, p0, Landroidx/appcompat/widget/x;->g:Z
...
.method a()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/x;->g()Z
    ...
    invoke-direct {p0, v0, v3, v2}, Landroidx/appcompat/widget/x;->a(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_3
    sget-object v4, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;

    monitor-enter v4

    :try_start_0
    sget-object v5, Landroidx/appcompat/widget/x;->k:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, v5}, Landroidx/appcompat/widget/x;->a(Landroid/graphics/RectF;)I

    move-result v5

    int-to-float v5, v5

    iget-object v6, p0, Landroidx/appcompat/widget/x;->i:Landroid/widget/TextView;
    ...
    invoke-virtual {p0, v1, v5}, Landroidx/appcompat/widget/x;->a(IF)V
...
.method a(I)V
    ...
    invoke-direct {p0, v1, v2, v3}, Landroidx/appcompat/widget/x;->a(FFF)V

    invoke-direct {p0}, Landroidx/appcompat/widget/x;->i()Z
    ...
    :cond_1
    invoke-direct {p0}, Landroidx/appcompat/widget/x;->h()V
...
.method a(IF)V
    ...
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/x;->a(F)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    sget-object v4, Ld/a/j;->AppCompatTextView:[I
    ...
    sget v4, Ld/a/j;->AppCompatTextView_autoSizeTextType:I
    ...
    iput v4, p0, Landroidx/appcompat/widget/x;->a:I

    :cond_0
    sget v4, Ld/a/j;->AppCompatTextView_autoSizeStepGranularity:I
    ...
    :cond_1
    sget v4, Ld/a/j;->AppCompatTextView_autoSizeMinTextSize:I
    ...
    :cond_2
    sget v4, Ld/a/j;->AppCompatTextView_autoSizeMaxTextSize:I
    ...
    :cond_3
    sget v4, Ld/a/j;->AppCompatTextView_autoSizePresetSizes:I
    ...
    invoke-direct {p0, v7}, Landroidx/appcompat/widget/x;->a(Landroid/content/res/TypedArray;)V
    ...
    iget v4, p0, Landroidx/appcompat/widget/x;->a:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_a

    iget-boolean v4, p0, Landroidx/appcompat/widget/x;->g:Z

    if-nez v4, :cond_8

    iget-object v4, p0, Landroidx/appcompat/widget/x;->j:Landroid/content/Context;
    ...
    :cond_7
    invoke-direct {p0, v0, v1, v2}, Landroidx/appcompat/widget/x;->a(FFF)V
    ...
    :cond_9
    iput v5, p0, Landroidx/appcompat/widget/x;->a:I
...
.method a([II)V
    ...
    :cond_0
    iget-object v2, p0, Landroidx/appcompat/widget/x;->j:Landroid/content/Context;
