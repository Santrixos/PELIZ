...
.field private final F:Ld/h/l/p;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->C:Landroid/animation/AnimatorListenerAdapter;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:Ld/h/l/p;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->A:Landroid/widget/OverScroller;
...
.method public a(I)V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/z;

    invoke-interface {v0}, Landroidx/appcompat/widget/z;->n()V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/z;->m()V
...
.method public a(Landroid/view/Menu;Landroidx/appcompat/view/menu/o$a;)V
    ...
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/z;->a(Landroid/view/Menu;Landroidx/appcompat/view/menu/o$a;)V
...
.method public b()V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/z;->b()V
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/z;->d()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0}, Ld/h/l/t;->u(Landroid/view/View;)I
    ...
    invoke-direct/range {v3 .. v9}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->a(Landroid/view/View;Landroid/graphics/Rect;ZZZZ)Z
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Landroid/graphics/Rect;

    invoke-static {p0, v4, v5}, Landroidx/appcompat/widget/x0;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Landroid/graphics/Rect;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroid/graphics/Rect;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:Ld/h/l/p;
...
.method j()V
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroidx/appcompat/widget/z;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->e:Landroidx/appcompat/widget/z;
...
.method protected onLayout(ZIIII)V
    ...
    check-cast v8, Landroidx/appcompat/widget/ActionBarOverlayLayout$e;
...
.method protected onMeasure(II)V
    ...
    invoke-static/range {p0 .. p0}, Ld/h/l/t;->u(Landroid/view/View;)I
    ...
    iget v1, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->a:I
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->s:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v0, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroid/graphics/Rect;

    iget-object v1, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-boolean v0, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->h:Z
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Landroid/graphics/Rect;

    iget-object v1, v7, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroid/graphics/Rect;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Ld/h/l/p;->a(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->d()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->b()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_2
    invoke-interface {v5, v2}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->a(Z)V
    ...
    :cond_4
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->z:Landroidx/appcompat/widget/ActionBarOverlayLayout$d;

    invoke-interface {v2}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->c()V
    ...
    invoke-interface {v2}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->a()V
...
.method public setActionBarVisibilityCallback(Landroidx/appcompat/widget/ActionBarOverlayLayout$d;)V
    ...
    invoke-interface {v0, v1}, Landroidx/appcompat/widget/ActionBarOverlayLayout$d;->a(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/z;->setWindowCallback(Landroid/view/Window$Callback;)V
