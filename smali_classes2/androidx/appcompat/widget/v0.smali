...
.method constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/v0;->e:Landroid/graphics/Rect;

    const/4 v0, 0x2

    new-array v1, v0, [I

    iput-object v1, p0, Landroidx/appcompat/widget/v0;->f:[I

    new-array v0, v0, [I

    iput-object v0, p0, Landroidx/appcompat/widget/v0;->g:[I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/v0;->b:Landroid/view/View;

    sget v1, Ld/a/f;->message:I
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/v0;->c:Landroid/widget/TextView;

    iget-object v0, p0, Landroidx/appcompat/widget/v0;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    sget v1, Ld/a/i;->Animation_AppCompat_Tooltip:I
...
.method private a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    sget v3, Ld/a/d;->tooltip_precise_anchor_threshold:I
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/v0;->a:Landroid/content/Context;

    invoke-virtual {v4}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    sget v5, Ld/a/d;->tooltip_precise_anchor_extra_offset:I
    ...
    iget-object v6, v0, Landroidx/appcompat/widget/v0;->a:Landroid/content/Context;
    ...
    sget v7, Ld/a/d;->tooltip_y_offset_touch:I

    goto :goto_2

    :cond_2
    sget v7, Ld/a/d;->tooltip_y_offset_non_touch:I
    ...
    invoke-static/range {p1 .. p1}, Landroidx/appcompat/widget/v0;->a(Landroid/view/View;)Landroid/view/View;
    ...
    :cond_3
    iget-object v8, v0, Landroidx/appcompat/widget/v0;->e:Landroid/graphics/Rect;
    ...
    iget-object v8, v0, Landroidx/appcompat/widget/v0;->a:Landroid/content/Context;
    ...
    iget-object v13, v0, Landroidx/appcompat/widget/v0;->e:Landroid/graphics/Rect;
    ...
    :cond_5
    iget-object v8, v0, Landroidx/appcompat/widget/v0;->g:[I

    invoke-virtual {v7, v8}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v8, v0, Landroidx/appcompat/widget/v0;->f:[I
    ...
    iget-object v10, v0, Landroidx/appcompat/widget/v0;->b:Landroid/view/View;
    ...
    iget-object v12, v0, Landroidx/appcompat/widget/v0;->f:[I
    ...
    iget-object v14, v0, Landroidx/appcompat/widget/v0;->e:Landroid/graphics/Rect;
...
.method a()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/v0;->b:Landroid/view/View;
...
.method a(Landroid/view/View;IIZLjava/lang/CharSequence;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/v0;->c:Landroid/widget/TextView;

    invoke-virtual {v0, p5}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v6, p0, Landroidx/appcompat/widget/v0;->d:Landroid/view/WindowManager$LayoutParams;
    ...
    invoke-direct/range {v1 .. v6}, Landroidx/appcompat/widget/v0;->a(Landroid/view/View;IIZLandroid/view/WindowManager$LayoutParams;)V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/v0;->d:Landroid/view/WindowManager$LayoutParams;
