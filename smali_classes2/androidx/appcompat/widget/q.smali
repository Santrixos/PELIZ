...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v0, p2}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v1, v0}, Landroidx/core/graphics/drawable/c;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v6, v7}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/q;->b:Landroid/graphics/Bitmap;

    if-nez v3, :cond_7

    iput-object v2, p0, Landroidx/appcompat/widget/q;->b:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/r0;->c(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_0

    iget-object v3, p0, Landroidx/appcompat/widget/q;->a:Landroid/widget/ProgressBar;

    invoke-direct {p0, v1}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/r0;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v2}, Landroidx/appcompat/widget/q;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
