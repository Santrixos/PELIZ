...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v2, Ld/a/j;->ActionBar_background:I

    invoke-virtual {v1, v2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->e:Landroid/graphics/drawable/Drawable;

    sget v2, Ld/a/j;->ActionBar_backgroundStacked:I
    ...
    sget v2, Ld/a/j;->ActionBar_height:I
    ...
    iput v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->j:I

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getId()I

    move-result v2

    sget v3, Ld/a/f;->split_action_bar:I

    const/4 v4, 0x1

    if-ne v2, v3, :cond_0

    iput-boolean v4, p0, Landroidx/appcompat/widget/ActionBarContainer;->h:Z

    sget v2, Ld/a/j;->ActionBar_backgroundSplit:I

    invoke-virtual {v1, v2}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->g:Landroid/graphics/drawable/Drawable;

    :cond_0
    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    iget-boolean v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->h:Z
    ...
    :cond_1
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->e:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_2

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContainer;->f:Landroid/graphics/drawable/Drawable;
...
.method public onLayout(ZIIII)V
    ...
    iget-boolean v4, p0, Landroidx/appcompat/widget/ActionBarContainer;->h:Z

    if-eqz v4, :cond_2

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarContainer;->g:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContainer;->c:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->getTop()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContainer;->c:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->getRight()I

    move-result v6

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarContainer;->c:Landroid/view/View;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarContainer;->d:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->getTop()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContainer;->d:Landroid/view/View;

    invoke-virtual {v6}, Landroid/view/View;->getRight()I

    move-result v6

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarContainer;->d:Landroid/view/View;
    ...
    :cond_5
    iput-boolean v3, p0, Landroidx/appcompat/widget/ActionBarContainer;->i:Z
...
.method public onMeasure(II)V
    ...
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/ActionBarContainer;->b(Landroid/view/View;)Z
    ...
    invoke-direct {p0, v4}, Landroidx/appcompat/widget/ActionBarContainer;->a(Landroid/view/View;)I
...
.method public setTabContainer(Landroidx/appcompat/widget/k0;)V
    .locals 2
