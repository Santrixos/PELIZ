...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/TextPaint;
    ...
    sget-object v4, Ld/a/j;->SwitchCompat:[I

    invoke-static {p1, p2, v4, p3, v1}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/r0;

    move-result-object v4

    sget v5, Ld/a/j;->SwitchCompat_android_thumb:I

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/r0;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget v5, Ld/a/j;->SwitchCompat_track:I
    ...
    :cond_1
    sget v5, Ld/a/j;->SwitchCompat_android_textOn:I

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/r0;->e(I)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->t:Ljava/lang/CharSequence;

    sget v5, Ld/a/j;->SwitchCompat_android_textOff:I

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/r0;->e(I)Ljava/lang/CharSequence;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->u:Ljava/lang/CharSequence;

    sget v5, Ld/a/j;->SwitchCompat_showText:I

    invoke-virtual {v4, v5, v3}, Landroidx/appcompat/widget/r0;->a(IZ)Z

    move-result v5

    iput-boolean v5, p0, Landroidx/appcompat/widget/SwitchCompat;->v:Z

    sget v5, Ld/a/j;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v4, v5, v1}, Landroidx/appcompat/widget/r0;->c(II)I

    move-result v5

    iput v5, p0, Landroidx/appcompat/widget/SwitchCompat;->p:I

    sget v5, Ld/a/j;->SwitchCompat_switchMinWidth:I

    invoke-virtual {v4, v5, v1}, Landroidx/appcompat/widget/r0;->c(II)I

    move-result v5

    iput v5, p0, Landroidx/appcompat/widget/SwitchCompat;->q:I

    sget v5, Ld/a/j;->SwitchCompat_switchPadding:I
    ...
    sget v5, Ld/a/j;->SwitchCompat_splitTrack:I

    invoke-virtual {v4, v5, v1}, Landroidx/appcompat/widget/r0;->a(IZ)Z

    move-result v5

    iput-boolean v5, p0, Landroidx/appcompat/widget/SwitchCompat;->s:Z

    sget v5, Ld/a/j;->SwitchCompat_thumbTint:I

    invoke-virtual {v4, v5}, Landroidx/appcompat/widget/r0;->a(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget v6, Ld/a/j;->SwitchCompat_thumbTintMode:I

    const/4 v7, -0x1

    invoke-virtual {v4, v6, v7}, Landroidx/appcompat/widget/r0;->d(II)I

    move-result v6

    invoke-static {v6, v0}, Landroidx/appcompat/widget/a0;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v6

    iget-object v8, p0, Landroidx/appcompat/widget/SwitchCompat;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget v8, Ld/a/j;->SwitchCompat_trackTint:I

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/r0;->a(I)Landroid/content/res/ColorStateList;
    ...
    :cond_6
    sget v9, Ld/a/j;->SwitchCompat_trackTintMode:I

    invoke-virtual {v4, v9, v7}, Landroidx/appcompat/widget/r0;->d(II)I

    move-result v7

    invoke-static {v7, v0}, Landroidx/appcompat/widget/a0;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_9
    sget v3, Ld/a/j;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v4, v3, v1}, Landroidx/appcompat/widget/r0;->g(II)I

    move-result v1

    if-eqz v1, :cond_a

    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/SwitchCompat;->a(Landroid/content/Context;I)V

    :cond_a
    invoke-virtual {v4}, Landroidx/appcompat/widget/r0;->a()V
    ...
    iput v7, p0, Landroidx/appcompat/widget/SwitchCompat;->x:I

    invoke-virtual {v3}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v7

    iput v7, p0, Landroidx/appcompat/widget/SwitchCompat;->B:I
...
.method private a(Ljava/lang/CharSequence;)Landroid/text/Layout;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/TextPaint;
...
.method private a(II)V
    ...
    :goto_0
    invoke-virtual {p0, v0, p2}, Landroidx/appcompat/widget/SwitchCompat;->a(Landroid/graphics/Typeface;I)V
...
.method private a(Z)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/animation/ObjectAnimator;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->P:Landroid/animation/ObjectAnimator;
...
.method private b(Landroid/view/MotionEvent;)V
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SwitchCompat;->A:Landroid/view/VelocityTracker;
    ...
    iget v6, p0, Landroidx/appcompat/widget/SwitchCompat;->B:I
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v2, v3}, Landroidx/appcompat/widget/r0;->c(II)I
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/TextPaint;
    ...
    :cond_1
    sget v4, Ld/a/j;->TextAppearance_android_typeface:I

    const/4 v5, -0x1

    invoke-virtual {v0, v4, v5}, Landroidx/appcompat/widget/r0;->d(II)I

    move-result v4

    sget v6, Ld/a/j;->TextAppearance_android_textStyle:I

    invoke-virtual {v0, v6, v5}, Landroidx/appcompat/widget/r0;->d(II)I

    move-result v5

    invoke-direct {p0, v4, v5}, Landroidx/appcompat/widget/SwitchCompat;->a(II)V

    sget v6, Ld/a/j;->TextAppearance_textAllCaps:I

    invoke-virtual {v0, v6, v3}, Landroidx/appcompat/widget/r0;->a(IZ)Z

    move-result v3

    if-eqz v3, :cond_2

    new-instance v6, Ld/a/m/a;

    invoke-virtual {p0}, Landroid/widget/CompoundButton;->getContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v6, v7}, Ld/a/m/a;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Landroidx/appcompat/widget/SwitchCompat;->O:Landroid/text/method/TransformationMethod;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v9, v7, v2, v8, v4}, Landroidx/core/graphics/drawable/a;->a(Landroid/graphics/drawable/Drawable;IIII)V
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->S:[I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/SwitchCompat;->Q:Landroid/graphics/Rect;

    iget-object v3, v0, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iget v4, v0, Landroidx/appcompat/widget/SwitchCompat;->H:I

    iget v5, v0, Landroidx/appcompat/widget/SwitchCompat;->J:I
    ...
    iget-object v8, v0, Landroidx/appcompat/widget/SwitchCompat;->a:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_2

    iget-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->s:Z

    if-eqz v9, :cond_1

    if-eqz v8, :cond_1

    invoke-static {v8}, Landroidx/appcompat/widget/a0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget-object v10, v0, Landroidx/appcompat/widget/SwitchCompat;->M:Landroid/text/Layout;

    goto :goto_2

    :cond_4
    iget-object v10, v0, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/text/Layout;
    ...
    iget-object v12, v0, Landroidx/appcompat/widget/SwitchCompat;->L:Landroid/content/res/ColorStateList;

    if-eqz v12, :cond_5

    iget-object v13, v0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/TextPaint;
    ...
    :cond_5
    iget-object v12, v0, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/text/TextPaint;
...
.method protected onLayout(ZIIII)V
    ...
    :goto_2
    iput v2, p0, Landroidx/appcompat/widget/SwitchCompat;->G:I

    iput v3, p0, Landroidx/appcompat/widget/SwitchCompat;->H:I

    iput v5, p0, Landroidx/appcompat/widget/SwitchCompat;->J:I

    iput v4, p0, Landroidx/appcompat/widget/SwitchCompat;->I:I
...
.method public onMeasure(II)V
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Landroid/text/Layout;
    ...
    iput v4, p0, Landroidx/appcompat/widget/SwitchCompat;->F:I
    ...
    invoke-static {v7}, Landroidx/appcompat/widget/a0;->d(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iput v7, p0, Landroidx/appcompat/widget/SwitchCompat;->D:I

    iput v8, p0, Landroidx/appcompat/widget/SwitchCompat;->E:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_4
    iget v8, p0, Landroidx/appcompat/widget/SwitchCompat;->C:F

    add-float/2addr v8, v7

    invoke-static {v8, v6, v5}, Landroidx/appcompat/widget/SwitchCompat;->a(FFF)F
    ...
    iget v5, p0, Landroidx/appcompat/widget/SwitchCompat;->y:F
    ...
    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/SwitchCompat;->a(FF)Z
...
.method public setThumbTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/SwitchCompat;->d:Z
...
.method public setThumbTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/SwitchCompat;->e:Z
...
.method public setTrackTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/SwitchCompat;->i:Z
...
.method public setTrackTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/SwitchCompat;->j:Z
