...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, Ld/a/j;->ActionMode_background:I
    ...
    sget v2, Ld/a/j;->ActionMode_titleTextStyle:I

    invoke-virtual {v0, v2, v1}, Landroidx/appcompat/widget/r0;->g(II)I

    move-result v2

    iput v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->u:I

    sget v2, Ld/a/j;->ActionMode_subtitleTextStyle:I

    invoke-virtual {v0, v2, v1}, Landroidx/appcompat/widget/r0;->g(II)I

    move-result v2

    iput v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->v:I

    sget v2, Ld/a/j;->ActionMode_height:I

    invoke-virtual {v0, v2, v1}, Landroidx/appcompat/widget/r0;->f(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/widget/a;->e:I

    sget v1, Ld/a/j;->ActionMode_closeItemLayout:I

    sget v2, Ld/a/g;->abc_action_mode_close_item_material:I

    invoke-virtual {v0, v1, v2}, Landroidx/appcompat/widget/r0;->g(II)I

    move-result v1

    iput v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->x:I
...
.method private e()V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;

    sget v2, Ld/a/f;->action_bar_title:I
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->s:Landroid/widget/TextView;

    iget-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;

    sget v2, Ld/a/f;->action_bar_subtitle:I
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->t:Landroid/widget/TextView;
    ...
    iget v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->v:I
...
.method public a(Ld/a/n/b;)V
    ...
    sget v1, Ld/a/f;->action_mode_close_button:I
    ...
    invoke-direct {v1, p0, p1}, Landroidx/appcompat/widget/ActionBarContextView$a;-><init>(Landroidx/appcompat/widget/ActionBarContextView;Ld/a/n/b;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Ld/a/n/b;->c()Landroid/view/Menu;

    move-result-object v1

    check-cast v1, Landroidx/appcompat/view/menu/h;

    iget-object v2, p0, Landroidx/appcompat/widget/a;->d:Landroidx/appcompat/widget/c;

    if-eqz v2, :cond_2

    invoke-virtual {v2}, Landroidx/appcompat/widget/c;->c()Z
    ...
    invoke-direct {v2, v3}, Landroidx/appcompat/widget/c;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Landroidx/appcompat/widget/a;->d:Landroidx/appcompat/widget/c;

    const/4 v3, 0x1

    invoke-virtual {v2, v3}, Landroidx/appcompat/widget/c;->c(Z)V
    ...
    invoke-virtual {v1, v3, v4}, Landroidx/appcompat/view/menu/h;->a(Landroidx/appcompat/view/menu/o;Landroid/content/Context;)V

    iget-object v3, p0, Landroidx/appcompat/widget/a;->d:Landroidx/appcompat/widget/c;

    invoke-virtual {v3, p0}, Landroidx/appcompat/widget/c;->b(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/p;

    move-result-object v3

    check-cast v3, Landroidx/appcompat/widget/ActionMenuView;

    iput-object v3, p0, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionMenuView;

    const/4 v4, 0x0

    invoke-static {v3, v4}, Ld/h/l/t;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object v3, p0, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionMenuView;
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v6, Landroidx/appcompat/widget/ActionBarContextView;->p:Landroid/view/View;
    ...
    invoke-static {v0, v12, v7}, Landroidx/appcompat/widget/a;->a(IIZ)I
    ...
    invoke-static {v14, v13, v7}, Landroidx/appcompat/widget/a;->a(IIZ)I
    ...
    iget-object v1, v6, Landroidx/appcompat/widget/ActionBarContextView;->q:Landroid/view/View;
    ...
    iget-object v1, v6, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;
    ...
    iget-object v1, v6, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionMenuView;
...
.method protected onMeasure(II)V
    ...
    iget-object v11, v0, Landroidx/appcompat/widget/ActionBarContextView;->p:Landroid/view/View;

    const/4 v12, 0x0

    if-eqz v11, :cond_1

    invoke-virtual {v0, v11, v7, v10, v12}, Landroidx/appcompat/widget/a;->a(Landroid/view/View;III)I
    ...
    :cond_1
    iget-object v11, v0, Landroidx/appcompat/widget/a;->c:Landroidx/appcompat/widget/ActionMenuView;
    ...
    :cond_2
    iget-object v11, v0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;

    if-eqz v11, :cond_7

    iget-object v13, v0, Landroidx/appcompat/widget/ActionBarContextView;->q:Landroid/view/View;

    if-nez v13, :cond_7

    iget-boolean v13, v0, Landroidx/appcompat/widget/ActionBarContextView;->w:Z
    ...
    iget-object v13, v0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;
    ...
    :cond_4
    iget-object v15, v0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;
    ...
    :cond_7
    :goto_3
    iget-object v11, v0, Landroidx/appcompat/widget/ActionBarContextView;->q:Landroid/view/View;
    ...
    :goto_8
    iget v1, v0, Landroidx/appcompat/widget/a;->e:I
