...
.method private b(Landroidx/appcompat/app/AlertController;)V
    ...
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->K:Landroid/database/Cursor;
    ...
    :cond_3
    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->w:Landroid/widget/ListAdapter;
    ...
    :cond_4
    new-instance v2, Landroidx/appcompat/app/AlertController$h;

    iget-object v4, p0, Landroidx/appcompat/app/AlertController$f;->a:Landroid/content/Context;

    iget-object v5, p0, Landroidx/appcompat/app/AlertController$f;->v:[Ljava/lang/CharSequence;

    invoke-direct {v2, v4, v1, v3, v5}, Landroidx/appcompat/app/AlertController$h;-><init>(Landroid/content/Context;II[Ljava/lang/CharSequence;)V

    move-object v1, v2

    :goto_1
    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->O:Landroidx/appcompat/app/AlertController$f$e;

    if-eqz v2, :cond_5

    invoke-interface {v2, v0}, Landroidx/appcompat/app/AlertController$f$e;->a(Landroid/widget/ListView;)V

    :cond_5
    iput-object v1, p1, Landroidx/appcompat/app/AlertController;->H:Landroid/widget/ListAdapter;

    iget v2, p0, Landroidx/appcompat/app/AlertController$f;->I:I

    iput v2, p1, Landroidx/appcompat/app/AlertController;->I:I

    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->x:Landroid/content/DialogInterface$OnClickListener;

    if-eqz v2, :cond_6

    new-instance v2, Landroidx/appcompat/app/AlertController$f$c;

    invoke-direct {v2, p0, p1}, Landroidx/appcompat/app/AlertController$f$c;-><init>(Landroidx/appcompat/app/AlertController$f;Landroidx/appcompat/app/AlertController;)V
    ...
    :cond_6
    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->J:Landroid/content/DialogInterface$OnMultiChoiceClickListener;

    if-eqz v2, :cond_7

    new-instance v2, Landroidx/appcompat/app/AlertController$f$d;

    invoke-direct {v2, p0, v0, p1}, Landroidx/appcompat/app/AlertController$f$d;-><init>(Landroidx/appcompat/app/AlertController$f;Landroidx/appcompat/app/AlertController$RecycleListView;Landroidx/appcompat/app/AlertController;)V

    invoke-virtual {v0, v2}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    :cond_7
    :goto_2
    iget-object v2, p0, Landroidx/appcompat/app/AlertController$f;->N:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    :cond_8
    iget-boolean v2, p0, Landroidx/appcompat/app/AlertController$f;->H:Z
    ...
    :cond_9
    iget-boolean v2, p0, Landroidx/appcompat/app/AlertController$f;->G:Z
