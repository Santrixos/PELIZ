...
.method constructor <init>(Landroidx/appcompat/app/AlertController$f;Landroid/content/Context;Landroid/database/Cursor;ZLandroidx/appcompat/app/AlertController$RecycleListView;Landroidx/appcompat/app/AlertController;)V
    ...
    iget-object p6, p0, Landroidx/appcompat/app/AlertController$f$b;->e:Landroidx/appcompat/app/AlertController$f;

    iget-object p6, p6, Landroidx/appcompat/app/AlertController$f;->L:Ljava/lang/String;

    invoke-interface {p5, p6}, Landroid/database/Cursor;->getColumnIndexOrThrow(Ljava/lang/String;)I

    move-result p6

    iput p6, p0, Landroidx/appcompat/app/AlertController$f$b;->a:I

    iget-object p6, p0, Landroidx/appcompat/app/AlertController$f$b;->e:Landroidx/appcompat/app/AlertController$f;

    iget-object p6, p6, Landroidx/appcompat/app/AlertController$f;->M:Ljava/lang/String;

    invoke-interface {p5, p6}, Landroid/database/Cursor;->getColumnIndexOrThrow(Ljava/lang/String;)I

    move-result p6

    iput p6, p0, Landroidx/appcompat/app/AlertController$f$b;->b:I
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget v1, p0, Landroidx/appcompat/app/AlertController$f$b;->a:I
    ...
    iget-object v1, p0, Landroidx/appcompat/app/AlertController$f$b;->c:Landroidx/appcompat/app/AlertController$RecycleListView;

    invoke-interface {p3}, Landroid/database/Cursor;->getPosition()I

    move-result v2

    iget v3, p0, Landroidx/appcompat/app/AlertController$f$b;->b:I
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/app/AlertController$f$b;->e:Landroidx/appcompat/app/AlertController$f;

    iget-object v0, v0, Landroidx/appcompat/app/AlertController$f;->b:Landroid/view/LayoutInflater;

    iget-object v1, p0, Landroidx/appcompat/app/AlertController$f$b;->d:Landroidx/appcompat/app/AlertController;
