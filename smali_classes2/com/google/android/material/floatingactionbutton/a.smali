...
.field c:Le/f/a/c/l/h;

.field d:Le/f/a/c/l/h;

.field private e:Le/f/a/c/l/h;

.field private f:Le/f/a/c/l/h;

.field private final g:Lcom/google/android/material/internal/l;

.field h:Le/f/a/c/s/a;
...
.field final u:Lcom/google/android/material/internal/o;

.field final v:Le/f/a/c/s/b;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Le/f/a/c/l/a;->c:Landroid/animation/TimeInterpolator;
...
.method constructor <init>(Lcom/google/android/material/internal/o;Le/f/a/c/s/b;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/a;->u:Lcom/google/android/material/internal/o;

    iput-object p2, p0, Lcom/google/android/material/floatingactionbutton/a;->v:Le/f/a/c/s/b;

    new-instance v0, Lcom/google/android/material/internal/l;

    invoke-direct {v0}, Lcom/google/android/material/internal/l;-><init>()V

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->g:Lcom/google/android/material/internal/l;

    sget-object v1, Lcom/google/android/material/floatingactionbutton/a;->C:[I

    new-instance v2, Lcom/google/android/material/floatingactionbutton/a$f;

    invoke-direct {v2, p0}, Lcom/google/android/material/floatingactionbutton/a$f;-><init>(Lcom/google/android/material/floatingactionbutton/a;)V

    invoke-direct {p0, v2}, Lcom/google/android/material/floatingactionbutton/a;->a(Lcom/google/android/material/floatingactionbutton/a$i;)Landroid/animation/ValueAnimator;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/google/android/material/internal/l;->a([ILandroid/animation/ValueAnimator;)V

    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->g:Lcom/google/android/material/internal/l;

    sget-object v1, Lcom/google/android/material/floatingactionbutton/a;->D:[I

    new-instance v2, Lcom/google/android/material/floatingactionbutton/a$e;

    invoke-direct {v2, p0}, Lcom/google/android/material/floatingactionbutton/a$e;-><init>(Lcom/google/android/material/floatingactionbutton/a;)V
    ...
    new-instance v2, Lcom/google/android/material/floatingactionbutton/a$h;

    invoke-direct {v2, p0}, Lcom/google/android/material/floatingactionbutton/a$h;-><init>(Lcom/google/android/material/floatingactionbutton/a;)V
    ...
    new-instance v2, Lcom/google/android/material/floatingactionbutton/a$d;

    invoke-direct {v2, p0}, Lcom/google/android/material/floatingactionbutton/a$d;-><init>(Lcom/google/android/material/floatingactionbutton/a;)V
...
.method private a(Le/f/a/c/l/h;FFF)Landroid/animation/AnimatorSet;
    .locals 9
    ...
    invoke-virtual {p1, v2}, Le/f/a/c/l/h;->a(Ljava/lang/String;)Le/f/a/c/l/i;
    ...
    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/a;->u:Lcom/google/android/material/internal/o;
    ...
    invoke-virtual {v4, v1}, Le/f/a/c/l/i;->a(Landroid/animation/Animator;)V

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v4, p0, Lcom/google/android/material/floatingactionbutton/a;->u:Lcom/google/android/material/internal/o;
    ...
    invoke-direct {p0, p4, v2}, Lcom/google/android/material/floatingactionbutton/a;->a(FLandroid/graphics/Matrix;)V

    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/a;->u:Lcom/google/android/material/internal/o;

    new-instance v4, Le/f/a/c/l/f;

    invoke-direct {v4}, Le/f/a/c/l/f;-><init>()V

    new-instance v6, Le/f/a/c/l/g;

    invoke-direct {v6}, Le/f/a/c/l/g;-><init>()V

    new-array v3, v3, [Landroid/graphics/Matrix;

    new-instance v7, Landroid/graphics/Matrix;

    iget-object v8, p0, Lcom/google/android/material/floatingactionbutton/a;->z:Landroid/graphics/Matrix;
    ...
    invoke-static {v2, v0}, Le/f/a/c/l/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method private a(FLandroid/graphics/Matrix;)V
    ...
    iget v3, p0, Lcom/google/android/material/floatingactionbutton/a;->q:I
...
.method private u()Le/f/a/c/l/h;
    .locals 2

    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->f:Le/f/a/c/l/h;
    ...
    sget v1, Le/f/a/c/a;->design_fab_hide_motion_spec:I

    invoke-static {v0, v1}, Le/f/a/c/l/h;->a(Landroid/content/Context;I)Le/f/a/c/l/h;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->f:Le/f/a/c/l/h;
...
.method private v()Le/f/a/c/l/h;
    .locals 2

    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->e:Le/f/a/c/l/h;
    ...
    sget v1, Le/f/a/c/a;->design_fab_show_motion_spec:I

    invoke-static {v0, v1}, Le/f/a/c/l/h;->a(Landroid/content/Context;I)Le/f/a/c/l/h;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->e:Le/f/a/c/l/h;
...
.method private x()V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->h:Le/f/a/c/s/a;
    ...
    invoke-virtual {v0, v1}, Le/f/a/c/s/a;->a(F)V
...
.method a(ILandroid/content/res/ColorStateList;)Lcom/google/android/material/internal/a;
    ...
    sget v2, Le/f/a/c/c;->design_fab_stroke_top_outer_color:I

    invoke-static {v0, v2}, Landroidx/core/content/a;->a(Landroid/content/Context;I)I

    move-result v2

    sget v3, Le/f/a/c/c;->design_fab_stroke_top_inner_color:I

    invoke-static {v0, v3}, Landroidx/core/content/a;->a(Landroid/content/Context;I)I

    move-result v3

    sget v4, Le/f/a/c/c;->design_fab_stroke_end_inner_color:I

    invoke-static {v0, v4}, Landroidx/core/content/a;->a(Landroid/content/Context;I)I

    move-result v4

    sget v5, Le/f/a/c/c;->design_fab_stroke_end_outer_color:I

    invoke-static {v0, v5}, Landroidx/core/content/a;->a(Landroid/content/Context;I)I

    move-result v5

    invoke-virtual {v1, v2, v3, v4, v5}, Lcom/google/android/material/internal/a;->a(IIII)V

    int-to-float v2, p1

    invoke-virtual {v1, v2}, Lcom/google/android/material/internal/a;->a(F)V
...
.method a(FFF)V
    ...
    invoke-virtual {v0, p1, v1}, Le/f/a/c/s/a;->a(FF)V
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Landroid/content/res/ColorStateList;I)V
    ...
    iput-object v1, p0, Lcom/google/android/material/floatingactionbutton/a;->k:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v4, p0, Lcom/google/android/material/floatingactionbutton/a;->l:Lcom/google/android/material/internal/a;
    ...
    iget-object v4, p0, Lcom/google/android/material/floatingactionbutton/a;->k:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, Lcom/google/android/material/floatingactionbutton/a;->m:Landroid/graphics/drawable/Drawable;

    iget-object v4, p0, Lcom/google/android/material/floatingactionbutton/a;->v:Le/f/a/c/s/b;

    invoke-interface {v4}, Le/f/a/c/s/b;->b()F

    move-result v7

    iget v8, p0, Lcom/google/android/material/floatingactionbutton/a;->n:F

    iget v4, p0, Lcom/google/android/material/floatingactionbutton/a;->p:F

    add-float v9, v8, v4

    move-object v4, v2

    invoke-direct/range {v4 .. v9}, Le/f/a/c/s/a;-><init>(Landroid/content/Context;Landroid/graphics/drawable/Drawable;FFF)V

    iput-object v2, p0, Lcom/google/android/material/floatingactionbutton/a;->h:Le/f/a/c/s/a;

    invoke-virtual {v2, v3}, Le/f/a/c/s/a;->a(Z)V

    iget-object v2, p0, Lcom/google/android/material/floatingactionbutton/a;->v:Le/f/a/c/s/b;

    iget-object v3, p0, Lcom/google/android/material/floatingactionbutton/a;->h:Le/f/a/c/s/a;

    invoke-interface {v2, v3}, Le/f/a/c/s/b;->a(Landroid/graphics/drawable/Drawable;)V
...
.method a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Le/f/a/c/s/a;->getPadding(Landroid/graphics/Rect;)Z
...
.method a(Lcom/google/android/material/floatingactionbutton/a$g;Z)V
    ...
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->d:Le/f/a/c/l/h;
    ...
    :cond_2
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/a;->u()Le/f/a/c/l/h;
    ...
    invoke-direct {p0, v0, v1, v1, v1}, Lcom/google/android/material/floatingactionbutton/a;->a(Le/f/a/c/l/h;FFF)Landroid/animation/AnimatorSet;
    ...
    iget-object v1, p0, Lcom/google/android/material/floatingactionbutton/a;->t:Ljava/util/ArrayList;
...
.method final a(Le/f/a/c/l/h;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/a;->d:Le/f/a/c/l/h;
...
.method b(Lcom/google/android/material/floatingactionbutton/a$g;Z)V
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/material/floatingactionbutton/a;->c:Le/f/a/c/l/h;
    ...
    :cond_3
    invoke-direct {p0}, Lcom/google/android/material/floatingactionbutton/a;->v()Le/f/a/c/l/h;
    ...
    iget-object v1, p0, Lcom/google/android/material/floatingactionbutton/a;->s:Ljava/util/ArrayList;
...
.method final b(Le/f/a/c/l/h;)V
    .locals 0

    iput-object p1, p0, Lcom/google/android/material/floatingactionbutton/a;->c:Le/f/a/c/l/h;
...
.method final s()V
    ...
    invoke-interface {v1, v2, v3, v4, v5}, Le/f/a/c/s/b;->a(IIII)V
