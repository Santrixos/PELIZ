...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-static {v0}, Lh/f;->a([B)Lh/f;
...
.method private declared-synchronized send(Lh/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILh/f;)V
...
.method checkResponse(Lokhttp3/Response;)V
    ...
    invoke-virtual {v4}, Lh/f;->l()Lh/f;

    move-result-object v4

    invoke-virtual {v4}, Lh/f;->a()Ljava/lang/String;
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v3, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILh/f;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    invoke-interface {v1}, Lokhttp3/Call;->timeout()Lh/w;

    move-result-object v1

    invoke-virtual {v1}, Lh/w;->clearTimeout()Lh/w;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lh/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLh/d;Ljava/util/Random;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lh/e;

    invoke-direct {v0, v1, v2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLh/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lh/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lh/f;)V
...
.method public declared-synchronized onReadPing(Lh/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lh/f;)V
    .locals 1
...
.method declared-synchronized pong(Lh/f;)Z
    .locals 1
...
.method public send(Lh/f;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lh/f;I)Z
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/ws/RealWebSocket;->send(Lh/f;I)Z
...
.method writeOneFrame()Z
    ...
    :try_start_1
    invoke-virtual {v4, v6}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lh/f;)V
    ...
    iget-object v5, v5, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lh/f;
    ...
    invoke-virtual {v4, v7, v8, v9}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lh/u;

    move-result-object v7

    invoke-static {v7}, Lh/l;->a(Lh/u;)Lh/d;

    move-result-object v7

    invoke-interface {v7, v5}, Lh/d;->c(Lh/f;)Lh/d;

    invoke-interface {v7}, Lh/u;->close()V
    ...
    iget-object v8, v5, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lh/f;

    invoke-virtual {v4, v7, v8}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILh/f;)V
...
.method writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v2, Lh/f;->e:Lh/f;

    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lh/f;)V
    :try_end_1
