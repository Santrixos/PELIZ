...
.method private newJournalWriter()Lh/d;
    .locals 3
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lh/u;

    move-result-object v0

    new-instance v1, Lokhttp3/internal/cache/DiskLruCache$2;

    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lh/u;)V

    invoke-static {v1}, Lh/l;->a(Lh/u;)Lh/d;
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lh/v;
    ...
    :try_start_0
    invoke-interface {v1}, Lh/e;->v()Ljava/lang/String;
    ...
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lh/d;

    move-result-object v7

    iput-object v7, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;

    invoke-interface {v0}, Lh/u;->close()V

    const/4 v0, 0x0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;

    const-string v2, "CLEAN"

    invoke-interface {v1, v2}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v1

    invoke-interface {v1, v4}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lh/d;)V

    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;

    invoke-interface {v1, v3}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-interface {v1}, Lh/d;->flush()V
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    invoke-interface {v1, v2}, Lh/d;->writeByte(I)Lh/d;

    move-result-object v1

    invoke-interface {v1, p1}, Lh/d;->b(Ljava/lang/String;)Lh/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v1, v3}, Lh/d;->b(Ljava/lang/String;)Lh/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lh/u;
    ...
    invoke-interface {v0, v3, v4}, Lh/d;->h(J)Lh/d;
    ...
    invoke-interface {v0, v2}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-interface {v0, v4}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v4

    invoke-interface {v4, v5}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lh/d;)V
    ...
    iput-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lh/d;
...
.method removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lh/d;->b(Ljava/lang/String;)Lh/d;
