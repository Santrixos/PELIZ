...
.field private sink:Lh/d;

.field private socket:Ljava/net/Socket;

.field private source:Lh/e;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {v2}, Lh/l;->b(Ljava/net/Socket;)Lh/v;

    move-result-object v2

    invoke-static {v2}, Lh/l;->a(Lh/v;)Lh/e;

    move-result-object v2

    iput-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {v2}, Lh/l;->a(Ljava/net/Socket;)Lh/u;

    move-result-object v2

    invoke-static {v2}, Lh/l;->a(Lh/u;)Lh/d;

    move-result-object v2

    iput-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {v3}, Lh/l;->b(Ljava/net/Socket;)Lh/v;

    move-result-object v8

    invoke-static {v8}, Lh/l;->a(Lh/v;)Lh/e;

    move-result-object v8

    iput-object v8, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iget-object v8, p0, Lokhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;

    invoke-static {v8}, Lh/l;->a(Ljava/net/Socket;)Lh/u;

    move-result-object v8

    invoke-static {v8}, Lh/l;->a(Lh/u;)Lh/d;

    move-result-object v8

    iput-object v8, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lh/e;Lh/d;)V
    ...
    invoke-virtual {v2, v5, v6, v3}, Lh/w;->timeout(JLjava/util/concurrent/TimeUnit;)Lh/w;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    invoke-interface {v2}, Lh/u;->timeout()Lh/w;
    ...
    :cond_0
    invoke-virtual {v1, v5, v6}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lh/v;
    ...
    invoke-static {v3, v7, v8}, Lokhttp3/internal/Util;->skipAll(Lh/v;ILjava/util/concurrent/TimeUnit;)Z

    invoke-interface {v3}, Lh/v;->close()V
    ...
    :cond_4
    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    invoke-interface {v7}, Lh/e;->c()Lh/c;

    move-result-object v7

    invoke-virtual {v7}, Lh/c;->g()Z

    move-result v7

    if-eqz v7, :cond_5

    iget-object v7, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    invoke-interface {v7}, Lh/d;->c()Lh/c;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lh/e;Lh/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v1, v7, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iput-object v1, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;
    ...
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lh/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lh/d;

    invoke-direct {v0, p1, p3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lh/e;Lh/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLh/e;Lh/d;Lokhttp3/internal/connection/StreamAllocation;)V
