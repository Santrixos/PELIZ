...
# instance fields
.field private final boundary:Lh/f;
...
.method constructor <init>(Lh/f;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Lh/f;
    ...
    invoke-virtual {p1}, Lh/f;->r()Ljava/lang/String;
...
.method private writeOrCountBytes(Lh/d;Z)J
    .locals 16
    .param p1    # Lh/d;
    ...
    invoke-interface {v4, v10}, Lh/d;->write([B)Lh/d;

    iget-object v10, v0, Lokhttp3/MultipartBody;->boundary:Lh/f;

    invoke-interface {v4, v10}, Lh/d;->c(Lh/f;)Lh/d;
    ...
    invoke-interface {v4, v12}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v12

    sget-object v13, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v12, v13}, Lh/d;->write([B)Lh/d;
    ...
    invoke-interface {v12, v13}, Lh/d;->b(Ljava/lang/String;)Lh/d;
    ...
    invoke-interface {v4, v11}, Lh/d;->b(Ljava/lang/String;)Lh/d;
    ...
    invoke-interface {v11, v12}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v11, v12}, Lh/d;->write([B)Lh/d;
    ...
    invoke-interface {v4, v13}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v13

    invoke-interface {v13, v11, v12}, Lh/d;->h(J)Lh/d;

    move-result-object v13

    sget-object v14, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v13, v14}, Lh/d;->write([B)Lh/d;
    ...
    invoke-interface {v4, v13}, Lh/d;->write([B)Lh/d;
    ...
    :cond_5
    invoke-virtual {v9, v4}, Lokhttp3/RequestBody;->writeTo(Lh/d;)V
    ...
    invoke-interface {v4, v5}, Lh/d;->write([B)Lh/d;

    iget-object v5, v0, Lokhttp3/MultipartBody;->boundary:Lh/f;

    invoke-interface {v4, v5}, Lh/d;->c(Lh/f;)Lh/d;
...
.method public boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Lh/f;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v2, v3}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lh/d;Z)J
...
.method public writeTo(Lh/d;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lh/d;Z)J
