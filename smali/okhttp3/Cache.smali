...
.method static readInt(Lh/e;)I
    ...
    :try_start_0
    invoke-interface {p0}, Lh/e;->k()J

    move-result-wide v0

    invoke-interface {p0}, Lh/e;->v()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v2, v4}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lh/v;

    move-result-object v4

    invoke-direct {v3, v4}, Lokhttp3/Cache$Entry;-><init>(Lh/v;)V
    :try_end_1
