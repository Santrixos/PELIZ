...
.method constructor <init>(Lh/v;)V
    ...
    :try_start_0
    invoke-static/range {p1 .. p1}, Lh/l;->a(Lh/v;)Lh/e;

    move-result-object v0

    invoke-interface {v0}, Lh/e;->v()Ljava/lang/String;
    ...
    invoke-static {v0}, Lokhttp3/Cache;->readInt(Lh/e;)I
    ...
    invoke-direct {v1, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lh/e;)Ljava/util/List;
    ...
    :goto_5
    invoke-interface/range {p1 .. p1}, Lh/v;->close()V
...
.method private readCertificateList(Lh/e;)Ljava/util/List;
    .locals 7
    ...
    invoke-static {p1}, Lokhttp3/Cache;->readInt(Lh/e;)I
    ...
    invoke-interface {p1}, Lh/e;->v()Ljava/lang/String;
    ...
    invoke-virtual {v5, v6}, Lh/c;->c(Lh/f;)Lh/c;

    invoke-virtual {v5}, Lh/c;->J()Ljava/io/InputStream;
...
.method private writeCertList(Lh/d;Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lh/d;->h(J)Lh/d;
    ...
    invoke-static {v3}, Lh/f;->a([B)Lh/f;
    ...
    invoke-interface {p1, v4}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v5

    invoke-interface {v5, v1}, Lh/d;->writeByte(I)Lh/d;
    :try_end_0
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lh/u;
    ...
    invoke-interface {v0, v5}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v5

    invoke-interface {v5, v4}, Lh/d;->b(Ljava/lang/String;)Lh/d;
    ...
    invoke-interface {v4, v5}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v4

    invoke-interface {v4, v2}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-interface {v0, v5, v6}, Lh/d;->h(J)Lh/d;
    ...
    invoke-interface {v5, v6}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v5

    invoke-interface {v5, v2}, Lh/d;->writeByte(I)Lh/d;
    ...
    invoke-interface {v1, v4}, Lh/d;->b(Ljava/lang/String;)Lh/d;

    move-result-object v1

    iget-wide v5, p0, Lokhttp3/Cache$Entry;->sentRequestMillis:J

    invoke-interface {v1, v5, v6}, Lh/d;->h(J)Lh/d;
    ...
    invoke-interface {v1, v3, v4}, Lh/d;->h(J)Lh/d;
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/Cache$Entry;->writeCertList(Lh/d;Ljava/util/List;)V
