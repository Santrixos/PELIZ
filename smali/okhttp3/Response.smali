...
.method public peekBody(J)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v0}, Lokhttp3/ResponseBody;->source()Lh/e;

    move-result-object v0

    invoke-interface {v0, p1, p2}, Lh/e;->d(J)Z

    invoke-interface {v0}, Lh/e;->c()Lh/c;

    move-result-object v1

    invoke-virtual {v1}, Lh/c;->clone()Lh/c;
    ...
    invoke-virtual {v2, v1, p1, p2}, Lh/c;->write(Lh/c;J)V

    invoke-virtual {v1}, Lh/c;->a()V
    ...
    invoke-static {v3, v4, v5, v2}, Lokhttp3/ResponseBody;->create(Lokhttp3/MediaType;JLh/e;)Lokhttp3/ResponseBody;
