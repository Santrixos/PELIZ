.class Lcom/tonyodev/fetch2/database/f$c;
.super Ld/u/b;
.source "SourceFile"
...
.method constructor <init>(Lcom/tonyodev/fetch2/database/f;Ld/u/f;)V
    ...
    iput-object p1, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
...
.method public a(Ld/v/a/f;Lcom/tonyodev/fetch2/database/g;)V
    ...
    iget-object v0, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    iget-object v1, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    iget-object v2, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    iget-object v3, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    iget-object v4, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    :goto_4
    iget-object v5, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    iget-object v7, p0, Lcom/tonyodev/fetch2/database/f$c;->d:Lcom/tonyodev/fetch2/database/f;
    ...
    invoke-interface {p1, v8, v9, v10}, Ld/v/a/d;->bindLong(IJ)V
...
.method public bridge synthetic a(Ld/v/a/f;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/tonyodev/fetch2/database/f$c;->a(Ld/v/a/f;Lcom/tonyodev/fetch2/database/g;)V
...
.method public c()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `requests` SET `_id` = ?,`_namespace` = ?,`_url` = ?,`_file` = ?,`_group` = ?,`_priority` = ?,`_headers` = ?,`_written_bytes` = ?,`_total_bytes` = ?,`_status` = ?,`_error` = ?,`_network_type` = ?,`_created` = ?,`_tag` = ?,`_enqueue_action` = ?,`_identifier` = ?,`_download_on_enqueue` = ?,`_extras` = ? WHERE `_id` = ?"
