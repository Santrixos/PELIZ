...
.method private _loadBanner(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    new-instance v1, Lcom/unity3d/services/banners/UnityBanners$BannerWrapper;

    invoke-direct {v1, p0, p1, v0}, Lcom/unity3d/services/banners/UnityBanners$BannerWrapper;-><init>(Lcom/unity3d/services/banners/UnityBanners;Landroid/content/Context;Lcom/unity3d/services/banners/UnityBanners$BannerAdRefreshView;)V

    iget-object v2, p0, Lcom/unity3d/services/banners/UnityBanners;->_currentBannerPosition:Lcom/unity3d/services/banners/view/BannerPosition;

    invoke-virtual {v1, v2}, Lcom/unity3d/services/banners/UnityBanners$BannerWrapper;->setBannerPosition(Lcom/unity3d/services/banners/view/BannerPosition;)V

    iput-object v1, p0, Lcom/unity3d/services/banners/UnityBanners;->_currentBannerWrapper:Lcom/unity3d/services/banners/UnityBanners$BannerWrapper;

    move-object v2, p0

    new-instance v3, Lcom/unity3d/services/banners/UnityBanners$1;

    invoke-direct {v3, p0, v2, v1}, Lcom/unity3d/services/banners/UnityBanners$1;-><init>(Lcom/unity3d/services/banners/UnityBanners;Lcom/unity3d/services/banners/UnityBanners;Lcom/unity3d/services/banners/UnityBanners$BannerWrapper;)V

    invoke-virtual {v0, v3}, Lcom/unity3d/services/banners/UnityBanners$BannerAdRefreshView;->setListener(Lcom/unity3d/services/banners/BannerView$IListener;)V
    ...
    :cond_0
    const-string v0, "A Banner is already in use, please call destroy before loading another banner!"
...
.method public static loadBanner(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    const-string v0, "UnityAds is not initialized."
