...
.method private getExperiment(Lcom/unity3d/ads/IUnityAdsTokenListener;Lcom/unity3d/services/core/configuration/IExperiments;)Lcom/unity3d/services/ads/gmascar/managers/BiddingBaseManager;
    ...
    new-instance v2, Lcom/unity3d/services/ads/gmascar/managers/BiddingEagerManager;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/unity3d/services/ads/gmascar/managers/BiddingEagerManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V

    return-object v2

    :cond_1
    sget-object v2, Lcom/unity3d/services/ads/gmascar/managers/BiddingManagerFactory$1;->$SwitchMap$com$unity3d$services$ads$gmascar$managers$SCARBiddingManagerType:[I
    ...
    new-instance v2, Lcom/unity3d/services/ads/gmascar/managers/BiddingDisabledManager;

    invoke-direct {v2, p1}, Lcom/unity3d/services/ads/gmascar/managers/BiddingDisabledManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V

    return-object v2

    :cond_2
    new-instance v2, Lcom/unity3d/services/ads/gmascar/managers/BiddingOnDemandManager;

    invoke-direct {v2, p1}, Lcom/unity3d/services/ads/gmascar/managers/BiddingOnDemandManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V

    return-object v2

    :cond_3
    new-instance v2, Lcom/unity3d/services/ads/gmascar/managers/BiddingLazyManager;

    invoke-direct {v2, p1}, Lcom/unity3d/services/ads/gmascar/managers/BiddingLazyManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V
    ...
    invoke-direct {v2, p1}, Lcom/unity3d/services/ads/gmascar/managers/BiddingEagerManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V

    return-object v2

    :cond_5
    :goto_0
    new-instance v0, Lcom/unity3d/services/ads/gmascar/managers/BiddingDisabledManager;

    invoke-direct {v0, p1}, Lcom/unity3d/services/ads/gmascar/managers/BiddingDisabledManager;-><init>(Lcom/unity3d/ads/IUnityAdsTokenListener;)V
