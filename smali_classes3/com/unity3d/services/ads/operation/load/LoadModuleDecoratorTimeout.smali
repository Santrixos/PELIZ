...
.method private releaseOperationTimeoutLock(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v2, v1, Lcom/unity3d/services/ads/operation/OperationState;->timeoutTimer:Lcom/unity3d/services/core/timer/BaseTimer;
    ...
    :cond_2
    invoke-virtual {v2}, Lcom/unity3d/services/core/timer/BaseTimer;->kill()V
...
.method private startLoadTimeout(Lcom/unity3d/services/ads/operation/load/LoadOperationState;)V
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/services/core/timer/BaseTimer;->start(Ljava/util/concurrent/ScheduledExecutorService;)V
