...
.method public static initialize(Landroid/content/Context;Ljava/lang/String;ZLcom/unity3d/ads/IUnityAdsInitializationListener;)V
    ...
    invoke-static {v4, v3, p1}, Lcom/unity3d/services/UnityServices;->createExpectedParametersString(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v6, v4, v5}, Lcom/unity3d/services/UnityServices;->createExpectedParametersString(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string v4, "Unity Ads SDK failed to initialize due to already being initialized with different parameters"
    ...
    invoke-static {v3}, Lcom/unity3d/services/core/log/DeviceLog;->warning(Ljava/lang/String;)V

    if-eqz p3, :cond_2

    sget-object v4, Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;->INVALID_ARGUMENT:Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;

    invoke-interface {p3, v4, v3}, Lcom/unity3d/ads/IUnityAdsInitializationListener;->onInitializationFailed(Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;Ljava/lang/String;)V
    ...
    const-string v1, "Unity Ads SDK failed to initialize due to device is not supported"
    ...
    const-string v0, "Error while initializing Unity Services: null context, halting Unity Ads init"
    ...
    const-string v1, "Unity Ads SDK failed to initialize due to null context"
    ...
    const-string v0, " in test mode, session "
    ...
    const-string v0, " in production mode, session "
    ...
    invoke-interface {v2}, Lcom/unity3d/services/core/configuration/IExperiments;->isNewInitFlowEnabled()Z
    ...
    invoke-interface {v3, v2}, Lcom/unity3d/services/core/configuration/IInitializeEventsMetricSender;->setNewInitFlow(Z)V

    if-eqz v2, :cond_d

    sget-object v3, Lcom/unity3d/services/UnityAdsSDK;->INSTANCE:Lcom/unity3d/services/UnityAdsSDK;

    invoke-virtual {v3}, Lcom/unity3d/services/UnityAdsSDK;->initialize()Lkotlinx/coroutines/j1;

    goto :goto_2

    :cond_d
    invoke-static {v1}, Lcom/unity3d/services/core/configuration/InitializeThread;->initialize(Lcom/unity3d/services/core/configuration/Configuration;)V

    :goto_2
    return-void

    :cond_e
    const-string v0, "Error while initializing Unity Services: cannot retrieve application context, halting Unity Ads init"

    invoke-static {v0}, Lcom/unity3d/services/core/log/DeviceLog;->error(Ljava/lang/String;)V

    sget-object v0, Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;->INVALID_ARGUMENT:Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;

    const-string v1, "Unity Ads SDK failed to initialize due to inability to retrieve application context"
    ...
    :cond_f
    const-string v0, "Error while initializing Unity Services: cannot retrieve application from context, halting Unity Ads init"

    invoke-static {v0}, Lcom/unity3d/services/core/log/DeviceLog;->error(Ljava/lang/String;)V

    sget-object v0, Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;->INVALID_ARGUMENT:Lcom/unity3d/ads/UnityAds$UnityAdsInitializationError;

    const-string v1, "Unity Ads SDK failed to initialize due to inability to retrieve application from context"
    ...
    :cond_10
    const-string v0, "Error while initializing Unity Services: invalid context, halting Unity Ads init"
    ...
    const-string v1, "Unity Ads SDK failed to initialize due to empty game ID"
