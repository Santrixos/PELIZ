...
.method private static isAllowedToSetConfiguration(Lcom/unity3d/services/core/configuration/Configuration;)Z
    ...
    sget-object v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics;->_configurationIsSet:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static setConfiguration(Lcom/unity3d/services/core/configuration/Configuration;)V
    ...
    const-string v0, "Metrics will not be sent from the device for this session due to misconfiguration"
    ...
    :cond_3
    const-string v0, "Metrics will not be sent from the device for this session"

    invoke-static {v0}, Lcom/unity3d/services/core/log/DeviceLog;->debug(Ljava/lang/String;)V

    new-instance v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics$NullInstance;

    const-string v1, "nullInstanceMetricsUrl"

    invoke-direct {v0, v1}, Lcom/unity3d/services/core/request/metrics/SDKMetrics$NullInstance;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics;->_instance:Lcom/unity3d/services/core/request/metrics/ISDKMetrics;

    :goto_0
    sget-object v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics;->_batchedSender:Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;

    if-nez v0, :cond_4

    new-instance v0, Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;
    ...
    invoke-direct {v0, v1, v2}, Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;-><init>(Lcom/unity3d/services/core/request/metrics/ISDKMetrics;Lcom/unity3d/services/core/properties/InitializationStatusReader;)V

    sput-object v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics;->_batchedSender:Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;
    ...
    invoke-virtual {v0, v1}, Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;->updateOriginal(Lcom/unity3d/services/core/request/metrics/ISDKMetrics;)V

    :goto_1
    sget-object v0, Lcom/unity3d/services/core/request/metrics/SDKMetrics;->_batchedSender:Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;

    invoke-virtual {v0}, Lcom/unity3d/services/core/request/metrics/MetricSenderWithBatch;->sendQueueIfNeeded()V
