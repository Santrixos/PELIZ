...
.method private getHttpUrlConnectionWithHeaders()Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v1, v2}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
...
.method public makeStreamRequest(Ljava/io/OutputStream;)J
    ...
    :try_start_2
    const-string v5, "Error while writing POST params"

    invoke-static {v5, v0}, Lcom/unity3d/services/core/log/DeviceLog;->exception(Ljava/lang/String;Ljava/lang/Exception;)V

    new-instance v5, Lcom/unity3d/services/core/request/NetworkIOException;

    new-instance v6, Ljava/lang/StringBuilder;

    invoke-direct {v6}, Ljava/lang/StringBuilder;-><init>()V

    const-string v7, "Error writing POST params: "
    ...
    invoke-direct {v5, v6}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
    ...
    iget v10, v1, Lcom/unity3d/services/core/request/WebRequest;->_responseCode:I

    iget-object v11, v1, Lcom/unity3d/services/core/request/WebRequest;->_responseHeaders:Ljava/util/Map;

    invoke-interface/range {v6 .. v11}, Lcom/unity3d/services/core/request/IWebRequestProgressListener;->onRequestStart(Ljava/lang/String;JILjava/util/Map;)V
    ...
    invoke-virtual {v4, v9, v0, v7}, Ljava/io/OutputStream;->write([BII)V

    int-to-long v12, v7

    add-long/2addr v10, v12

    iget-object v14, v1, Lcom/unity3d/services/core/request/WebRequest;->_progressListener:Lcom/unity3d/services/core/request/IWebRequestProgressListener;
    ...
    iget-wide v12, v1, Lcom/unity3d/services/core/request/WebRequest;->_contentLength:J

    move-wide/from16 v16, v10

    move-wide/from16 v18, v12

    invoke-interface/range {v14 .. v19}, Lcom/unity3d/services/core/request/IWebRequestProgressListener;->onRequestProgress(Ljava/lang/String;JJ)V
    ...
    const-string v12, "Unknown Exception: "
    ...
    invoke-direct {v2, v8}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
    ...
    const-string v7, "Can\'t open error stream: "
    ...
    invoke-direct {v2, v6}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, v5}, Lcom/unity3d/services/core/request/NetworkIOException;-><init>(Ljava/lang/String;)V
...
.method public setBody(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/unity3d/services/core/request/WebRequest;->_body:[B
