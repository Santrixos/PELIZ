...
.method public static initialize(Lcom/unity3d/services/store/core/StoreExceptionHandler;)V
    ...
    sget-object v5, Lcom/unity3d/services/store/gpbl/BillingResultResponseCode;->OK:Lcom/unity3d/services/store/gpbl/BillingResultResponseCode;

    invoke-virtual {v5}, Lcom/unity3d/services/store/gpbl/BillingResultResponseCode;->getResponseCode()I
    ...
    new-instance v2, Lcom/unity3d/services/store/StoreMonitor$1;

    invoke-direct {v2}, Lcom/unity3d/services/store/StoreMonitor$1;-><init>()V

    invoke-direct {v0, v1, v2}, Lcom/unity3d/services/store/gpbl/StoreBilling;-><init>(Landroid/content/Context;Lcom/unity3d/services/store/listeners/IPurchaseUpdatedResponseListener;)V

    sput-object v0, Lcom/unity3d/services/store/StoreMonitor;->_storeBilling:Lcom/unity3d/services/store/gpbl/StoreBilling;

    new-instance v1, Lcom/unity3d/services/store/StoreMonitor$2;

    invoke-direct {v1}, Lcom/unity3d/services/store/StoreMonitor$2;-><init>()V

    invoke-virtual {v0, v1}, Lcom/unity3d/services/store/gpbl/StoreBilling;->initialize(Lcom/unity3d/services/store/gpbl/IBillingClientStateListener;)V
...
.method public static isFeatureSupported(ILjava/lang/String;)I
    ...
    sget-object v3, Lcom/unity3d/services/store/StoreEvent;->IS_FEATURE_SUPPORTED_REQUEST_RESULT:Lcom/unity3d/services/store/StoreEvent;
    ...
    sget-object v2, Lcom/unity3d/services/store/StoreMonitor;->_storeExceptionHandler:Lcom/unity3d/services/store/core/StoreExceptionHandler;

    sget-object v3, Lcom/unity3d/services/store/StoreEvent;->IS_FEATURE_SUPPORTED_REQUEST_ERROR:Lcom/unity3d/services/store/StoreEvent;

    invoke-virtual {v2, v3, p0, v1}, Lcom/unity3d/services/store/core/StoreExceptionHandler;->handleStoreException(Lcom/unity3d/services/store/StoreEvent;ILjava/lang/Exception;)V
