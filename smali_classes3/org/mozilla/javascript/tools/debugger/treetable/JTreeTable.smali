...
.method public constructor <init>(Lorg/mozilla/javascript/tools/debugger/treetable/TreeTableModel;)V
    ...
    invoke-virtual {p0, v1}, Lorg/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setShowGrid(Z)V

    new-instance v2, Ljava/awt/Dimension;

    invoke-direct {v2, v1, v1}, Ljava/awt/Dimension;-><init>(II)V

    invoke-virtual {p0, v2}, Lorg/mozilla/javascript/tools/debugger/treetable/JTreeTable;->setIntercellSpacing(Ljava/awt/Dimension;)V
