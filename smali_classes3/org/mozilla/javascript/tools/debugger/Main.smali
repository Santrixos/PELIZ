...
.method public static main([Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v4}, Lorg/mozilla/javascript/tools/debugger/Main;->setSize(II)V
...
.method private static mainEmbeddedImpl(Lorg/mozilla/javascript/ContextFactory;Ljava/lang/Object;Ljava/lang/String;)Lorg/mozilla/javascript/tools/debugger/Main;
    ...
    instance-of v1, p1, Lorg/mozilla/javascript/tools/debugger/ScopeProvider;

    if-eqz v1, :cond_1

    move-object v1, p1

    check-cast v1, Lorg/mozilla/javascript/tools/debugger/ScopeProvider;

    invoke-virtual {v0, v1}, Lorg/mozilla/javascript/tools/debugger/Main;->setScopeProvider(Lorg/mozilla/javascript/tools/debugger/ScopeProvider;)V
    ...
    instance-of v3, v1, Lorg/mozilla/javascript/tools/shell/Global;

    if-eqz v3, :cond_2

    move-object v3, v1

    check-cast v3, Lorg/mozilla/javascript/tools/shell/Global;

    invoke-virtual {v0}, Lorg/mozilla/javascript/tools/debugger/Main;->getIn()Ljava/io/InputStream;

    move-result-object v4

    invoke-virtual {v3, v4}, Lorg/mozilla/javascript/tools/shell/Global;->setIn(Ljava/io/InputStream;)V

    invoke-virtual {v0}, Lorg/mozilla/javascript/tools/debugger/Main;->getOut()Ljava/io/PrintStream;

    move-result-object v4

    invoke-virtual {v3, v4}, Lorg/mozilla/javascript/tools/shell/Global;->setOut(Ljava/io/PrintStream;)V

    invoke-virtual {v0}, Lorg/mozilla/javascript/tools/debugger/Main;->getErr()Ljava/io/PrintStream;

    move-result-object v4

    invoke-virtual {v3, v4}, Lorg/mozilla/javascript/tools/shell/Global;->setErr(Ljava/io/PrintStream;)V
