...
.method private static buildBlocks([Lorg/mozilla/javascript/Node;)[Lorg/mozilla/javascript/optimizer/Block;
    ...
    invoke-static {v2, v4}, Lorg/mozilla/javascript/optimizer/Block;->newFatBlock(II)Lorg/mozilla/javascript/optimizer/Block$FatBlock;
    ...
    :cond_1
    invoke-virtual {v1, v4}, Lorg/mozilla/javascript/ObjArray;->add(Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-static {v2, v3}, Lorg/mozilla/javascript/optimizer/Block;->newFatBlock(II)Lorg/mozilla/javascript/optimizer/Block$FatBlock;
    ...
    iget-object v8, v4, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->realBlock:Lorg/mozilla/javascript/optimizer/Block;

    iget v8, v8, Lorg/mozilla/javascript/optimizer/Block;->itsEndNodeIndex:I
    ...
    check-cast v10, Lorg/mozilla/javascript/ast/Jump;

    iget-object v10, v10, Lorg/mozilla/javascript/ast/Jump;->target:Lorg/mozilla/javascript/Node;
    ...
    iget-object v12, v11, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->realBlock:Lorg/mozilla/javascript/optimizer/Block;

    invoke-virtual {v10, v6, v12}, Lorg/mozilla/javascript/Node;->putProp(ILjava/lang/Object;)V

    invoke-virtual {v4, v11}, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->addSuccessor(Lorg/mozilla/javascript/optimizer/Block$FatBlock;)V

    invoke-virtual {v11, v4}, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->addPredecessor(Lorg/mozilla/javascript/optimizer/Block$FatBlock;)V
    ...
    new-array v3, v3, [Lorg/mozilla/javascript/optimizer/Block;
    ...
    invoke-virtual {v1, v4}, Lorg/mozilla/javascript/ObjArray;->get(I)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lorg/mozilla/javascript/optimizer/Block$FatBlock;

    iget-object v6, v5, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->realBlock:Lorg/mozilla/javascript/optimizer/Block;

    invoke-virtual {v5}, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->getSuccessors()[Lorg/mozilla/javascript/optimizer/Block;

    move-result-object v7

    iput-object v7, v6, Lorg/mozilla/javascript/optimizer/Block;->itsSuccessors:[Lorg/mozilla/javascript/optimizer/Block;

    invoke-virtual {v5}, Lorg/mozilla/javascript/optimizer/Block$FatBlock;->getPredecessors()[Lorg/mozilla/javascript/optimizer/Block;

    move-result-object v7

    iput-object v7, v6, Lorg/mozilla/javascript/optimizer/Block;->itsPredecessors:[Lorg/mozilla/javascript/optimizer/Block;

    iput v4, v6, Lorg/mozilla/javascript/optimizer/Block;->itsBlockID:I
...
.method private static findDefPoints(Lorg/mozilla/javascript/optimizer/OptFunctionNode;Lorg/mozilla/javascript/Node;[I)Z
    ...
    invoke-virtual {p0, v1}, Lorg/mozilla/javascript/optimizer/OptFunctionNode;->getVarIndex(Lorg/mozilla/javascript/Node;)I
    ...
    invoke-static {p2, v2, v3}, Lorg/mozilla/javascript/optimizer/Block;->assignType([III)Z
    ...
    :cond_4
    invoke-static {p2, v5, v4}, Lorg/mozilla/javascript/optimizer/Block;->assignType([III)Z
...
.method private lookForVariableAccess(Lorg/mozilla/javascript/optimizer/OptFunctionNode;Lorg/mozilla/javascript/Node;)V
    ...
    iget-object v2, p0, Lorg/mozilla/javascript/optimizer/Block;->itsNotDefSet:Ljava/util/BitSet;
    ...
    invoke-direct {p0, p1, v1}, Lorg/mozilla/javascript/optimizer/Block;->lookForVariableAccess(Lorg/mozilla/javascript/optimizer/OptFunctionNode;Lorg/mozilla/javascript/Node;)V
...
.method private static reachingDefDataFlow(Lorg/mozilla/javascript/optimizer/OptFunctionNode;[Lorg/mozilla/javascript/Node;[Lorg/mozilla/javascript/optimizer/Block;[I)V
    ...
    invoke-direct {v1, p0, p1}, Lorg/mozilla/javascript/optimizer/Block;->initLiveOnEntrySets(Lorg/mozilla/javascript/optimizer/OptFunctionNode;[Lorg/mozilla/javascript/Node;)V
    ...
    invoke-direct {v5}, Lorg/mozilla/javascript/optimizer/Block;->doReachedUseDataFlow()Z
    ...
    iget-object v5, v5, Lorg/mozilla/javascript/optimizer/Block;->itsPredecessors:[Lorg/mozilla/javascript/optimizer/Block;
    ...
    invoke-direct {v3, p3}, Lorg/mozilla/javascript/optimizer/Block;->markAnyTypeVariables([I)V
...
.method static runFlowAnalyzes(Lorg/mozilla/javascript/optimizer/OptFunctionNode;[Lorg/mozilla/javascript/Node;)V
    ...
    invoke-virtual {p0, v4}, Lorg/mozilla/javascript/optimizer/OptFunctionNode;->setIsNumberVar(I)V
