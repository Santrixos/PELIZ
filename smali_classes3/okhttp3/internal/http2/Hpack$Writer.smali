...
.method constructor <init>(IZLh/c;)V
    ...
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lh/c;
...
.method constructor <init>(Lh/c;)V
    ...
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLh/c;)V
...
.method writeByteString(Lh/f;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lh/f;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Lh/f;Lh/d;)V

    invoke-virtual {v0}, Lh/c;->o()Lh/f;

    move-result-object v2

    invoke-virtual {v2}, Lh/f;->n()I
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lh/c;

    invoke-virtual {v1, v2}, Lh/c;->c(Lh/f;)Lh/c;
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lh/c;
...
.method writeHeaders(Ljava/util/List;)V
    ...
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lh/f;

    invoke-virtual {v4}, Lh/f;->o()Lh/f;

    move-result-object v4

    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lh/f;
    ...
    iget-object v10, v10, Lokhttp3/internal/http2/Header;->value:Lh/f;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->name:Lh/f;
    ...
    iget-object v12, v12, Lokhttp3/internal/http2/Header;->value:Lh/f;
    ...
    iget-object v10, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lh/c;

    invoke-virtual {v10, v9}, Lh/c;->writeByte(I)Lh/c;

    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lh/f;)V

    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lh/f;)V
    ...
    :cond_8
    sget-object v10, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lh/f;

    invoke-virtual {v4, v10}, Lh/f;->b(Lh/f;)Z

    move-result v10

    if-eqz v10, :cond_9

    sget-object v10, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lh/f;

    invoke-virtual {v10, v4}, Lh/f;->equals(Ljava/lang/Object;)Z
...
.method writeInt(III)V
    ...
    invoke-virtual {v0, v1}, Lh/c;->writeByte(I)Lh/c;
    ...
    invoke-virtual {v1, v2}, Lh/c;->writeByte(I)Lh/c;
