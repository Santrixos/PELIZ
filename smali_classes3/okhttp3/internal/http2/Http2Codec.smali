...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Lh/f;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Ljava/lang/String;)V

    invoke-interface {v1, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v2, Lokhttp3/internal/http2/Header;

    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:Lh/f;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lh/f;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Ljava/lang/String;)V
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Lh/f;
    ...
    invoke-direct {v3, v4, v5}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Ljava/lang/String;)V
    ...
    invoke-direct {v6, v5, v7}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Ljava/lang/String;)V
...
.method public createRequestBody(Lokhttp3/Request;J)Lh/u;
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lh/u;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v4}, Lokhttp3/internal/http2/Http2Stream;->getSource()Lh/v;

    move-result-object v4

    invoke-direct {v3, p0, v4}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Lh/v;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {v2}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lh/w;
    ...
    invoke-virtual {v2, v3, v4, v5}, Lh/w;->timeout(JLjava/util/concurrent/TimeUnit;)Lh/w;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {v2}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lh/w;
