...
# direct methods
.method constructor <init>(IILh/v;)V
    .locals 1
    ...
    invoke-static {p3}, Lh/l;->a(Lh/v;)Lh/e;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lh/e;

    return-void
.end method

.method constructor <init>(ILh/v;)V
    .locals 0

    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILh/v;)V
...
.method private getName(I)Lh/f;
    ...
    iget-object v0, v0, Lokhttp3/internal/http2/Header;->name:Lh/f;
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Header;->name:Lh/f;
...
.method private readByte()I
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lh/e;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lh/f;

    move-result-object v0

    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lh/f;

    move-result-object v1

    new-instance v2, Lokhttp3/internal/http2/Header;

    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Lh/f;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lh/f;)Lh/f;
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lh/f;Lh/f;)V
...
.method readByteString()Lh/f;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lh/e;

    int-to-long v5, v2

    invoke-interface {v4, v5, v6}, Lh/e;->f(J)[B
    ...
    :cond_1
    iget-object v3, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lh/e;

    int-to-long v4, v2

    invoke-interface {v3, v4, v5}, Lh/e;->a(J)Lh/f;
