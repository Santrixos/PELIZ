...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lh/d;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lh/d;Z)V
    ...
    iget-object v4, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lh/e;

    iget-boolean v5, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v4, v5}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lh/e;Z)V
...
.method pushDataLater(ILh/e;IZ)V
    .locals 10
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p2, v1, v2}, Lh/e;->g(J)V

    int-to-long v1, p3

    invoke-interface {p2, v0, v1, v2}, Lh/v;->read(Lh/c;J)J
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILh/c;IZ)V
...
.method public writeData(IZLh/c;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v1, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILh/c;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILh/c;I)V
