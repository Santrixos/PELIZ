...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lh/v;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lh/v;[J)V
    :try_end_0
...
.method writeLengths(Lh/d;)V
    ...
    invoke-interface {p1, v5}, Lh/d;->writeByte(I)Lh/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lh/d;->h(J)Lh/d;
